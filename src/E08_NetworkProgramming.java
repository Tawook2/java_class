...
public class E08_NetworkProgramming {
	...
	// # IP주소
	//	- 다른 컴퓨터를 찾아가기 위한 주소
	//	- 각 자리수가 0-255다 (0.0.0.0 ~ 255.255.255.255)
	
	// # 프로토콜
	//	- 프로그램간의 의사소통을 하기위한 규칙
	//	- TCP, FTP, Telnet, SMTP
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				if(count % 10 == 0) {
					System.err.printf("(축) 접속자 %d명 돌파",count);
				}else if(count == 100) {
					break;
				}
			}
