...
public class TranspositionCipher extends Cipher {
	...
	// # 전치 암호
	//	- 메세지를 Key값 만큼의 길이를 나눈 뒤 다른 방향으로 읽어서 암호화 하는 방식
	...
	// eccryption 메서드의 형식을 시저암호와 일치시키는 것이 좋다
...
//		System.out.println("꽉 찬 줄 개수 : " + numOfFull);
